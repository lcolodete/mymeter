...
public class AtivacaoMessageBuilder__AreasEspeciais_2CAD6H_Caminhao extends AtivacaoMessageBuilder {
	...
	public void setOtherFields(ISOMsg message) throws ISOException {
		...
		//2 CAD 6H
		setISOField_CodigoTarifa(message, TestData.COD_TARIFA_AREAS_ESPECIAIS_2CAD6H);
		//Caminhao
